...
@Entity
@Table(name = "medc_purchase" ,catalog="medc_accounts")
public class PurchaseJournal {
	...
	public Double getPurcflag() {
		return purcflag;
	}
	public void setPurcflag(Double purcflag) {
		this.purcflag = purcflag;
	}
