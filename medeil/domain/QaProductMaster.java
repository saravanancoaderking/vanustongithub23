...
@Entity
@Table(name = "medc_qa_custproductmaster", catalog = "medc_productmaster")
public class QaProductMaster implements Serializable {
	...
	public Integer getQaproductdrugid() {
		return qaproductdrugid;
	}

	public void setQaproductdrugid(Integer qaproductdrugid) {
		this.qaproductdrugid = qaproductdrugid;
	}
